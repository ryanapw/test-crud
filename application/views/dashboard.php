            ...
            <div class="card-body pb-0">
                <div class="review-block">
                    <div class="row">
                        ...
                        <div class="col">
                            <h6 class="m-b-15">John Deo <span class="float-right f-13 text-muted"> a week ago</span>
                            </h6>
                            ...
                            <a href="#!"><i class="feather icon-star f-18 text-muted"></i></a>
                            <p class="m-t-15 m-b-15 text-muted">Lorem Ipsum is simply dummy text of the printing and
